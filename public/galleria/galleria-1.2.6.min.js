...
!0):c.onreadystatechange=function(){if(!h&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete"))h=!0}:/file:\/\//i.test(a)?h=!0:e.ajax({url:a,success:function(){h=!0},error:function(a){a.isRejected()&&Galleria.WEBKIT&&(h=!0)}})},10));typeof d==="function"&&f.wait({until:function(){return h&&m.styleSheets.length>j},success:function(){k.setTimeout(function(){d.call(c,c)},100)},error:function(){Galleria.raise("Theme CSS could not load",!0)},timeout:1E10});return c}}}(),F=function(){var a=
